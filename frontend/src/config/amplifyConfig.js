...
export const snsConfig = {
  registrationTopicArn: 'arn:aws:sns:ca-central-1:796973501829:DALScooterRegistrationTopic-dev', // From Terraform output
  signInTopicArn: 'arn:aws:sns:ca-central-1:796973501829:DALScooterRegistrationTopic-dev' // From Terraform output
};